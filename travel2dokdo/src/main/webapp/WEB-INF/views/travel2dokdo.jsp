...
<body>
	...
	<!-- end of Container -->
	<div class="container">
		<div class="page-title pb-40" Style="font-family: 'Black Han Sans', sans-serif;">
			<h2 class="page-title__title">독도 여행</h2>
		</div>
			...
			<div class="col l12 s12 m6">
				<div class="card">
					<div class="card-title">
						<!-- Reserve 이미지 -->
						<img alt="Reserve" src="resources/images/dokdo/reserve.png" height="22px" width="30px">
						<b>독도행 여객선 예약하기</b>
					</div>
					<div class="card-content">
						<a href="https://island.haewoon.co.kr">
							<img alt="#" src="resources/images/dokdo/island2go.png">
						</a>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col l12 s12 m6">
				<div class="card">
					<div class="card-title">
						<!-- 준비물 이미지 -->
						<img alt="neccesaries" src="resources/images/dokdo/supplies.png" height="22px" width="30px">
						<b>독도행 여객선 예약하기</b>
					</div>
					<div class="card-content">
						<strong>신분증,태극기,멀미약,독도수비대 간식</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col l12 s12 m6">
				<div class="card">
					<div class="card-title">
						<!-- 카메라 이미지 -->
						<img alt="camera" src="resources/images/dokdo/photo.png" height="22px" width="30px">
						<b>독도 포토존</b>
					</div>
					<div class="card-content">
						<!-- 지도가 들어갈 영역 -->
	...
	<script>
		...
		mapOption = {
			center : new kakao.maps.LatLng(37.240800652169746, 131.8668849620806), // 지도의 중심좌표
			level : 4
		// 지도의 확대 레벨
		};
		...
		*/		
		...
		var marker1 = new kakao.maps.Marker({
			map : map,
			image : markerImage,
			position : new kakao.maps.LatLng(37.2389621293276, 131.869127982224)
		});
		/* 2.동도 나루터 -> 경위도 131.8676453683928/ 37.23958832331944 */
		var marker2 = new kakao.maps.Marker({
			map : map,
			image : markerImage,
			position : new kakao.maps.LatLng(37.23958832331944, 131.8676453683928)
		});
		/* 3.독도 대한민국동쪽땅끝표석 -> 경위도 131.86815699973258 / 37.23920129218755 */
		var marker3 = new kakao.maps.Marker({
			map : map,
			image : markerImage,
			position : new kakao.maps.LatLng(37.23920129218755, 131.86815699973258)
		});
		/* 4.독도 부채바위 -> 경위도 131.86795985738146/ 37.23867706202352 */
		var marker4 = new kakao.maps.Marker({
			map : map,
			image : markerImage,
			position : new kakao.maps.LatLng(37.23867706202352, 131.86795985738146)
		});
