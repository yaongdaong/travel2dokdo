...
<body>
	...
	<div class="wil-content">
		...
		<section class="awe-section">
			<div class="container">
				...
				<div class="page-title pb-40" Style="font-family: 'Black Han Sans', sans-serif;">
					<h2 class="page-title__title">울릉도 여행 코스</h2>
				</div>
				<!-- End / page-title -->
			</div>
		</section>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col s12 m6" id="map_box">
					<div class="map_wrap">
						<div class="col s12 m6" id="map" style="width: 600px; height: 450px; position: relative; overflow: hidden;"></div>
						<ul id="category">
							<li id="AT4" data-order="0"><span class="category_bg bank"></span> 관광지</li>
							<li id="FD6" data-order="0"><span class="category_bg bank"></span> 음식점</li>
				...
				<div class="col s12 m6">
					<img src="http://www.outdoornews.co.kr/news/photo/201908/31263_86527_1858.jpg" alt="임시 독도사진" width="600px" height="450px">
				</div>
	...
	<script>
		...
		mapOption = {
			center : new kakao.maps.LatLng(37.50368833279666, 130.85764252479746), // 지도의 중심좌표  =>울릉도
			level : 8
		// 지도의 확대 레벨
		};
