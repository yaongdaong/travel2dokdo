	...
	<div class="container">
		...
		<div class="row">
			<div class="col s12 m6" id="map_box">
				<div class="map_wrap">
					...
					<p style="margin-top: -12px">
						<em class="link"> <a href="/web/documentation/#CategoryCode" target="_blank">카테고리 코드목록을 보시려면 여기를 클릭하세요!</a>
						</em>
					</p>
			...
			<div class="col s12 m6">
				<img src="resources/images/dokdo1.png" alt="임시 독도사진" width="600px" height="450px">
			</div>
