...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="resources/images/dokdo/Logo_travel2dokdo.png" alt="..." /></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="#services">독도접안지수</a></li>
                        <li class="nav-item"><a class="nav-link" href="#portfolio">독도여행</a></li>
                        <li class="nav-item"><a class="nav-link" href="#about">울릉도여행</a></li>
